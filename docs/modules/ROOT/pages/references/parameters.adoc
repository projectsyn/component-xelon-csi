...
Container image to use for the Xelon CSI driver.
See the upstream list of https://github.com/xelonag/xelon-csi/releases[available versions] for supported values.

[NOTE]
====
You can also configure the following images:
...
You need to provide `registry`, `repository` and `tag`!
====
